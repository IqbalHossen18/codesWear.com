            ...
            <Image priority={true} style={{height:'450px', width:'450px'}} width={300} height={300} alt="ecommerce" className="lg:w-1/2 w-full  rounded" src="/hoodies.jpg"/>
              <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                ...
                <div className="flex">
                  ...
                  <button onClick={()=>{addToCart(slug , 1 , 499 , 'Wear the code' , 'xl' , 'Red')}} className="flex ml-4 text-white bg-pink-500 border-0 py-2 px-2 md:px-6 focus:outline-none hover:bg-pink-600 rounded">Add to Cart</button>
                ...
                <div className="flex mt-3">
                     ...
                     <button onClick={checkpin} className="flex ml-4 text-white bg-red-300 border-0 py-2 px-6 focus:outline-none hover:bg-red-400 rounded">
                     Check Pin
                     </button>
                </div>
